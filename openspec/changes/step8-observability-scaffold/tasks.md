...
## 9. User-Owned Follow-On Work

Moved to the `step8-metric-design` change on 2026-08-20 — see `openspec/changes/step8-metric-design/tasks.md`. This section had grown into a second change: the metric label design, the counter-seeding fix, the Grafana dashboard, the load generator and the end-to-end verification all landed here, despite the heading saying it was reference only and not implemented by this change. Do not restate any of it here.
